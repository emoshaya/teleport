...
func NewKubernetesClusterV3WithoutSecrets(cluster KubeCluster) (*KubernetesClusterV3, error) {
	...
	clusterWithoutCreds, err := NewKubernetesClusterV3(
		...
		WithKubeClusterScope(copiedCluster.GetScope()),
	)
...
// WithKubeClusterScope is an option that sets the scope when building a KubernetesClusterV3.
func WithKubeClusterScope(scope string) kubeClusterOpt {
