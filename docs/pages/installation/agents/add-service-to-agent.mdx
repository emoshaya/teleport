...
resources](../../enroll-resources/enroll-resources.mdx) for how to configure the new Teleport
service.
...
1. Stop the agent, delete the data directory, and start the agent again:
